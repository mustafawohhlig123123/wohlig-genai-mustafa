...
API_KEY = os.getenv("pineconeapi")  # Using the correct variable name
ENVIRONMENT = "us-west1"  # Update region to a supported one like us-west1
INDEX_NAME = "my-vector-index"  # Keep the index name the same

# Ensure API key is loaded correctly
if not API_KEY:
    raise ValueError("pineconeapi is missing. Make sure it's in the .env file and loaded correctly.")

# Initialize Pinecone client using the updated method
